...
namespace IncuSmart.Test.Tests
{
    public class SensorControllerTests
    {
        ...
        private static readonly List<Sensor> SampleSensors =
        [
        ...
        [Fact] // F01-TC01: Tạo sensor mới hợp lệ → 200
        ...
        [Fact] // F01-TC03: Mã hardware sensor đã tồn tại → 409
        ...
        [Fact] // F02-TC01: Lấy danh sách sensor của máy ấp hợp lệ → 200
        public async Task GetByIncubatorId_ValidIncubator_Returns200()
        {
            _sensorUseCase.Setup(x => x.GetByIncubatorId(IncubatorId, It.IsAny<Guid?>(), "ADMIN"))
                .ReturnsAsync(ControllerTestBase.OkResult<List<Sensor>>(SampleSensors));
        ...
        [Fact] // F02-TC03: Customer xem sensor máy của người khác → 403
        public async Task GetByIncubatorId_CustomerForbidden_Returns403()
        {
            ...
            _sensorUseCase.Setup(x => x.GetByIncubatorId(It.IsAny<Guid>(), It.IsAny<Guid?>(), "CUSTOMER"))
                .ReturnsAsync(ControllerTestBase.ForbiddenResult<List<Sensor>>("Không có quyền xem sensor này"));
        ...
        // ─── F03: GetSensorReadings ───────────────────────────────────────────────────

        [Fact] // F03-TC01: Lấy dữ liệu cảm biến không lọc → 200
        ...
        [Fact] // F03-TC02: Lọc theo sensorId → 200
        ...
        [Fact] // F03-TC03: Lọc theo khoảng thời gian 24 giờ gần nhất → 200
        ...
        [Fact] // F03-TC04: Máy ấp không tồn tại → 404
