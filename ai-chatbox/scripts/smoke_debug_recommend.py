...
def main() -> None:
    parser = argparse.ArgumentParser(description="Smoke test the /debug/recommend path.")
    ...
    payload = {
        ...
        "user_context": {
            ...
            "ambient_humidity": 67,
            "notes": "debug recommend",
        },
    }

    base_url = resolve_base_url(args.base_url)
    response = requests.post(f"{base_url}/debug/recommend", json=payload, timeout=120)
